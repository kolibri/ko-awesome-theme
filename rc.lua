...
mymainmenu = awful.menu({ items = { { "awesome", myawesomemenu, beautiful.ko_icon },
                                    { "terminal", terminal },
                                    { "chromium", 'chromium' },
                                    { "subl", 'subl' }
                                  }
...
mylauncher = awful.widget.launcher({ image = beautiful.ko_icon,
                                     menu = mymainmenu })
mytestlauncher = awful.widget.launcher( {"terminal", terminal})

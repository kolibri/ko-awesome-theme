	...
	local function update_icon()
		...
		if nil == brightness then
			...
			if brightness == 15 then 
				brightness_icon_file = beautiful.widget_launcher_8
			elseif brightness >= 13 then
				brightness_icon_file = beautiful.widget_launcher_7
			elseif brightness >= 11 then
				brightness_icon_file = beautiful.widget_launcher_6
			elseif brightness >= 9 then
				brightness_icon_file = beautiful.widget_launcher_5
			elseif brightness >= 7 then
				brightness_icon_file = beautiful.widget_launcher_4
			elseif brightness >= 5 then
				brightness_icon_file = beautiful.widget_launcher_3
			elseif brightness >= 3 then
				brightness_icon_file = beautiful.widget_launcher_2
			elseif brightness >= 1 then
				brightness_icon_file = beautiful.widget_launcher_1
			else 
				brightness_icon_file = beautiful.widget_launcher_0
			end
